...
export const GroupTable: React.FC<GroupTableProps> = ({
  ...
  return (
    <div className="rounded-xl border border-white/8 bg-[#111111]/80 backdrop-blur-md overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between bg-white/3 px-4 py-3 border-b border-white/6">
        <h3
      ...
      <div className="p-3">
              ...
              return (
                <TableRow
                  ...
                  className={`border-white/4 transition-colors ${
                    isUser ? "bg-white/8 font-semibold" : "hover:bg-white/3"
                  }`}
                >
        ...
        {showMatches && (
          <div className="mt-3 pt-3 border-t border-white/6 space-y-2 animate-fade-in">
...
const GroupMatchRow: React.FC<{ match: MatchResult }> = ({ match }) => {
  ...
  return (
    <div className="flex items-center justify-between text-xs bg-white/3 p-2 rounded-lg hover:bg-white/6 transition-colors border border-white/4">
      <TeamLogo
      ...
      <div className="flex items-center gap-1 font-mono">
        ...
        <span className="text-white/40">{map ? map.loserRounds : 12}</span>
      </div>
